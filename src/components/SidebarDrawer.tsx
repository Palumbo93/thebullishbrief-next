...
/**
 * SidebarDrawer component for navigation.
 * Slides in from the left with a modern app-like design.
 * Can be used on both mobile and desktop for condensed navigation.
 */
export interface SidebarDrawerNavItem {
  id: string;
  label: string;
...
interface SidebarDrawerProps {
  ...
  user?: { initials: string; username?: string; isAdmin?: boolean } | null;
  onSignInClick?: () => void;
  onSignUpClick?: () => void;
  onLogoutClick?: () => void;
}
    ...
    <>
      <style>{`
        ...
        .sidebar-header {
          ...
          .sidebar-auth-button.primary {
            background: rgba(255, 255, 255, 0.1);
            color: var(--color-text-primary);
          }
          .sidebar-auth-button.primary:hover {
            background: rgba(255, 255, 255, 0.15);
            transform: translateY(-1px);
          }
          .sidebar-auth-button.secondary {
            background: transparent;
            color: var(--color-text-secondary);
            border: 0.5px solid var(--color-border-secondary);
          }
          .sidebar-auth-button.secondary:hover {
            background: rgba(255, 255, 255, 0.05);
            color: var(--color-text-primary);
            border-color: var(--color-border-tertiary);
          }
          .sidebar-auth-button.danger {
            background: transparent;
            color: var(--color-text-secondary);
          }
          .sidebar-auth-button.danger:hover {
            background: rgba(255, 255, 255, 0.05);
        ...
        @media (max-width: 768px) {
          /* Mobile-specific overrides can go here if needed */
        }
      `}</style>
      {/* Backdrop */}
      <div
          ...
          {user ? (
            <>
              ...
              <div className="sidebar-auth-buttons">
                <button 
                  className="sidebar-auth-button danger" 
            ...
            <div className="sidebar-auth-buttons">
              <button 
                className="sidebar-auth-button primary" 
                onClick={() => {
                  onClose();
                  onSignUpClick?.();
                }}
